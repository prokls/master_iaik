...
reasoning about states in those hash functions possible using SAT solvers.
...
%$x_0$ or $x_1$ already wiped
%out differences and therefore yielded the same hash value.
%A common suffix $p$ changes the hash value to the same value.
