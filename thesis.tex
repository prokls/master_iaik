...
\DeclareMathOperator\IF{\texttt{IF\,}}
\DeclareMathOperator\MAJ{\texttt{MAJ\,}}
...
\setmathfont{Asana Math} % TODO: |N is missing again
\setmathfont[range={"2115}]{Linux Libertine O}% "0221E = \infty
...
\begin{abstract}%
  ...
  Whereas propagations can be automated using dedicated tools,
  ...
  SAT research at same time faces similar problems. SAT solvers implement heuristics
  to find satisfying assignments for Boolean functions. They also propagate values
  once knowledge about the problem gets derived.
