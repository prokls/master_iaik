...
\begin{abstract}%
  ...
  In this thesis we look at differential characteristics representing hash collisions
  and encode them as SAT problem. A SAT solver tells us whether this characteristic
  represents a valid hash state. We implemented a framework generating CNFs for
  these purposes and improved our CNF design to solve MD4 testcases as well as
  much more difficult SHA-256 testcases. Our greatest achievement was finding a
  SHA-256 hash collision over 24 rounds.
