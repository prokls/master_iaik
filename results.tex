...
\begin{prop}
  Simplification reduces the problem size (number of variables, number of clauses).
\end{prop}

First we look at simplification in terms of problem size. Consider for example
Testcase~\ref{sec:tc18} in the basic encoding introduced in Section~\ref{sec:enc-original}.
Then simplification will reduce the problem size down by 57--77~\% of its original size:
