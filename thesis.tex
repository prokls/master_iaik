...
\begin{abstract}%
  ...
  as they can be specified with arbitrary levels of granularity.

  SAT solvers inherently implement both tasks.
  They consecutively propagate values which limit the search space.
  The probability to find a satisfiable assignment increases if the limited search
