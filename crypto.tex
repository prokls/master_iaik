...
TODO illustrate how differences propagate by an addition example illustrated in differential notation

TODO reference to Magnus Daum's thesis

\section{Differential path}

TODO refer to some testcase which shows a differential path with many unresolved differences.
Then show the corresponding testcase where \dnI{?} became \dnI{-} and \dnI{x}.
